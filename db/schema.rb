...
ActiveRecord::Schema[7.0].define(version: 20_230_505_124_136) do
  create_table 'access_controls', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[role_id action_id], name: 'index_access_controls_on_role_id_and_action_id', unique: true
  end
  ...
  create_table 'board_subscriptions', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[user_id board_id], name: 'index_board_subscriptions_on_user_id_and_board_id', unique: true
  end
  ...
  create_table 'stories', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[board_id column_id], name: 'index_stories_on_board_id_and_column_id'
    t.index %w[board_id user_id], name: 'index_stories_on_board_id_and_user_id'
